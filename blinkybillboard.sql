...
CREATE TABLE IF NOT EXISTS `Viewers` (
  `viewer_id` int(10) unsigned auto_increment NOT NULL,
  `socket` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'IP + port of viewer',
  CONSTRAINT Viewrs_PK PRIMARY KEY (`viewer_id`),
...
CREATE TABLE IF NOT EXISTS `Scheduling` (
  `schedule_id` int(11) unsigned auto_increment NOT NULL COMMENT 'The ID is per billboard, per viewer',
  ...
  CONSTRAINT Scheduling_PK PRIMARY KEY (schedule_id,billboard_id,viewer_id),
